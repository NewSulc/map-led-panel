<template>
    <div v-if="xSize <= ySize" class="main" @mousedown="isMouseClicked = true" @mouseup="isMouseClicked = false">
        <div class="led-grid-h">
            <div class="column-h" v-for="y in ySize">
                <div class="led-h" v-for="x in xSize" @mousedown="changeLed(x-1, y-1)" @mouseenter="drawLed(x-1, y-1)">
    ...
    <div v-else class="main" @mousedown="isMouseClicked = true" @mouseup="isMouseClicked = false">
        <div class="led-grid-w">
            <div class="column-w" v-for="y in xSize">
                <div class="led-w" v-for="x in ySize" @mousedown="changeLed(y-1, x-1)" @mouseenter="drawLed(y-1, x-1)">
...
function drawLed(x, y){
    if(isMouseClicked) changeLed(x, y)
}
</script>
